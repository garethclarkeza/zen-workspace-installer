...
#    source ~/.nvm/nvm.sh
    ...
    echo -e "${GREEN}[INSTALLING]${WHITE}\tInstalling node js version $INSTALL_NODE_VER"
#    nvm install ${INSTALL_NODE_VER}

    echo -e "${GREEN}[INSTALLING]${WHITE}\tMake this version system default"
...
#    npm install -g npm
    ...
    echo -e "${GREEN}[INSTALLING]${WHITE}\tInstalling Yarn package manager"
#    rm -rf ~/.yarn
...
#    yarn config set prefix ~/.yarn -g
    ...
    echo -e "${GREEN}[INSTALLING]${WHITE}\tYarn $(yarn --version) installed"
}
